...
class AppRouter {
  Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      // Crops — FIX: addCrop and editCrop were missing BlocProvider
      ...
      // Marketplace — FIX: was missing BlocProvider entirely
      ...
      // FIX: Notifications, analytics, gov dashboard were completely missing
