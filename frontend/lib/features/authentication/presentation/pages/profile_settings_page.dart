            ...
            return Column(
              ...
              children: [
                ...
                _MenuItem(
                  ...
                  title: 'My Profile',
                  subtitle: 'Edit name, phone, location & photo',
                  onTap: () {
                    // Pop the settings page and land on the Profile tab (index 3)
                    // inside HomePage's IndexedStack — that's where the real
                    // profile editor lives.  Using popUntil ensures we always
                    // return to the root HomePage regardless of stack depth.
                ...
                _MenuItem(
                  ...
                  title: 'Server URL',
                  subtitle: 'Set backend IP for real device',
                  onTap: () =>
                      Navigator.pushNamed(context, RouteNames.serverSettings),
                ),
